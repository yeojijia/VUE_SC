<template>
  <div class="form">
    <div class="form-content">
      <div class="inp-con">
        <span>{{$t('user.desc59')}}：</span>
        <input :type="eyeShow1?'password':'text'" :placeholder="$t('user.desc27')">
      ...
      <div class="inp-con">
        ...
        <input type="text" :placeholder="$t('user.desc17')" v-model="code">
        <div class="time">
...
import { _sendEmailCode } from '@/utils/api/user'
