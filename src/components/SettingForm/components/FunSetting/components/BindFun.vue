<template>
  <div class="form">
    <div class="form-content">
      <div class="inp-con">
        <span>{{$t('user.desc57')}}：</span>
        <div class="inp">
          <input :type="eyeShow1?'password':'text'" :placeholder="$t('user.desc50')" v-model="password1">
      ...
      <div class="inp-con">
        ...
        <div class="inp">
          <input :type="eyeShow2?'password':'text'" :placeholder="$t('user.desc51')" v-model="password2">
          <img class="eye show" :src="require(`../../../../../assets/images/common/${theme}/icon_eye.svg`)"
...
import { _setFundPassword, _sendEmailCode } from '@/utils/api/user'
